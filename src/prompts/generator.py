...
## ⚠️ قاعدة هامة جداً
**أجب بالعربية الفصحى فقط!** لا تستخدم أي لغة أخرى مطلقاً (لا إنجليزية، لا صينية، لا غيرها).
إذا كان السؤال اختياراً من متعدد، اذكر حرف الإجابة الصحيحة (A أو B أو C أو D) بوضوح.
